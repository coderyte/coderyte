class Registrant < ActiveRecord::Base
	...
	validates :reason, :problem, :story, :more_story, :price_range, :experience, :first_name, :last_name, :gender, :email, :phone, :age, :residence, :education, :about_us, presence: true
	...
	def update_spreadsheet
		...
		ws[last_row, 13] = self.more_story
		ws[last_row, 14] = self.experience
		ws[last_row, 15] = self.price_range
		ws.save
	end
end